...
I've been facing the same issue and thus decided to make a very minimal and customizable responsive grid system for myself and other peers around the world.
